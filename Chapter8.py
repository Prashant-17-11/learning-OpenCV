...
def getContours(img):
    ...
    for cnt in contours:
        ...
        if area > 500:
            ...
            cv2.putText(imgBoundingBox, objType, (x+(w//2)-30, y+h+20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
...
imgStack = stackImages(0.6, ([img, imgGray, imgBlur], [imgCanny, imgContour, imgBoundingBox]))
